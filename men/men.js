var callData = JSON.parse(localStorage.getItem("mensPageData"));
...
function temp()
{
    window.location.href="/men/data/data.html";
}
...
var path = document.createElement("div");
    //    <-------------------- change this------------------>
path.innerText="Home > Men's Grooming: Shop All Products";
var mensGrooming = document.createElement("div");
    //    <-------------------- change this------------------>
mensGrooming.innerText="Men's Grooming: Shop All Products (2097)";
// <----------------All Products start--------------->
...
sortHiddenDiv_discount_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
    //    <-------------------- change this------------------>
        var getDataForDiscount = JSON.parse(localStorage.getItem("mensPageData"));
        getDataForDiscount.map(function (element)
        {
            ...
            //    <-------------------- change this------------------>
            localStorage.setItem("mensPageData",JSON.stringify(arr))
...
sortHiddenDiv_name_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForName = JSON.parse(localStorage.getItem("mensPageData"));
...
sortHiddenDiv_rated_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForRating = JSON.parse(localStorage.getItem("mensPageData"));
        getDataForRating.map(function (element,index)
        {
            ...
            // localStorage.setItem("fragrance_perfume_data",JSON.stringify(arr))
        })
        getDataForRating.map(function (element,index)
        {
            if(index%2==0)
...
sortHiddenDiv_high_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForHigh = JSON.parse(localStorage.getItem("mensPageData"));
...
sortHiddenDiv_low_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForLow = JSON.parse(localStorage.getItem("mensPageData"));
...
callMenData.map(function(element,index)
{
    ...
    var callQty = JSON.parse(localStorage.getItem("mensPageData"));
